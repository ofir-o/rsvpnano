...
- `rsvp-nano-rev2.bin` is the full browser-flasher image for Touch LCD 3.49 GPIO42 boards.
- `rsvp-nano-rev2-ota.bin` is the Touch LCD 3.49 GPIO42 OTA binary.
...
The rev2/GPIO42 artifacts are for boards where the default firmware boots but
brightness/backlight control does not respond.
